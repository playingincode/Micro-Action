...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    def prepare_train_frames(self, idx):
        ...
        # print("Video path",)
        complete_path_videomaev2_features=os.path.join("/srv/storage/stars@storage3.sophia.grid5000.fr/areka/areka/CVPR/Features_upper_limb_RGB_MA_52/",relative_path)
